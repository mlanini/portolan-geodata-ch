# AGENTS.md — Boundaries & Administrative Units

Administrative boundaries, localities and postal codes, and the official register of Swiss municipalities that keys them together.

## Collections in this catalog

- `boundaries/swissboundaries3d` — swissBOUNDARIES3D — Administrative Boundaries
