...
- Base URL: `https://ch-geodata.s3.eu-north-1.amazonaws.com/boundaries/swissboundaries3d/`
...
```sql
SELECT b.name, b.bfs_nummer FROM read_parquet('https://ch-geodata.s3.eu-north-1.amazonaws.com/boundaries/swissboundaries3d/swissboundaries3d.parquet') b WHERE ST_Contains(b.geometry, ST_Point(7.447,46.948));
```
